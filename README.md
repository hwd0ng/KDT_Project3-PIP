...
이러한 아이디어로부터 착안해 컴퓨터 비전 기술을 활용해 실시간으로 얼굴을 탐지하고 자동으로 모자이크 처리를 해주는 방송 애플리케이션을 개발하고자 하였습니다.

이를 통해 콘텐츠 제작자들이 윤리적이고 법적으로 안전한 영상을 제작할 수 있도록 지원하며, 일반 시민들의 개인정보와 초상권을 보호하는 것을 목표로 하였습니다.
